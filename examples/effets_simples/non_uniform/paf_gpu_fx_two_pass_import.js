...
import('./././Codes_separes/BAndWhite.js')
...
import('./././contrast_test.js')
       .then( obj => { print('Module loaded: contrast_test' + obj.code + ' nb uniforms ' + obj.uniforms.length); fx_mod2 = obj; counter--;})
       .catch( err => { counter--; print('Failed to load object ./contrast_test.js: ' + err); });
